...
exports.generateCode = exports.objEquals = exports.replaceStr = exports.replace = exports.randomBool = exports.random = exports.remove = void 0;
/**
 ...
 * @returns array
 */
function remove(element, array, options) {
 ...
 * @returns array
 */
function replace(element, array, replaceElement, options) {
 ...
 * @returns string
 */
function replaceStr(array, string, replaceString) {
 ...
 * @returns boolean
 */
function objEquals(obj1, obj2, options) {
    ...
    for (let i = 0; i < objKeys.length; i++) {
        if (typeof obj1[objKeys[i]] == 'object' &&
            objEquals(obj1[objKeys[i]], obj2[objKeys[i]], { strict: options?.strict }))
            continue;
        if ((options?.strict ?
